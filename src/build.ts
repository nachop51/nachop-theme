...
const themes: Array<{ name: string } & object> = [
  ...
  buildThemeFromColors({ colors: lightSchema, name: 'Nachop Light', isBordered: true }) as { name: string },
  buildThemeFromColors({ colors: lightSchema, name: 'Nachop Light', isBordered: false }) as { name: string }, buildThemeFromColors({ colors: facuSchema, name: 'Facu', isBordered: true }) as { name: string }, buildThemeFromColors({ colors: facuSchema, name: 'Facu', isBordered: false }) as { name: string }, buildThemeFromColors({ colors: piggySchema, name: 'Piggy', isBordered: true }) as { name: string }, buildThemeFromColors({ colors: piggySchema, name: 'Piggy', isBordered: false }) as { name: string }
]
